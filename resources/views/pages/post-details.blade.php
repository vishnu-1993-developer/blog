                  ...
                  <div class="col-lg-12">
                    <div class="blog-post">
                      <div class="blog-thumb">
                        <img src="{{ url('images/blog-post-02.jpg') }}" alt="">
                      </div>
                        ...
                        <ul>
                          <li>
                            <div class="author-thumb">
                              <img src="{{ url('images/comment-author-01.jpg') }}" alt="">
                            </div>
                          ...
                          <li class="replied">
                            <div class="author-thumb">
                              <img src="{{ url('images/comment-author-02.jpg') }}" alt="">
                            </div>
                            <div class="right-content">
                          ...
                          <li>
                            <div class="author-thumb">
                              <img src="{{ url('images/comment-author-03.jpg') }}" alt="">
                            </div>
                            <div class="right-content">
