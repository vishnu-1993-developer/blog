...
<title> {{ $siteSetting->site_name ?? 'Expert Info' }} </title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="manifest" href="site.webmanifest">
<link rel="shortcut icon" type="image/x-icon" href={{ url('blog-assets/img/favicon.ico') }}>
<!-- CSS here -->
...
<link rel="stylesheet" href={{ url('blog-assets/css/ticker-style.css') }}>
<link rel="stylesheet" href={{ url('blog-assets/css/flaticon.css') }}>
